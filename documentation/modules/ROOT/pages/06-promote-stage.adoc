...
We have to get the offline color. We can get it form Openshift or from the file 'values/products/envs/stage/non-static-networking-values.yaml' to get the color that the offline services is using. Then edit the following files in the right environment and color.
