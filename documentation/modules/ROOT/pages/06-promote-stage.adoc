...
First we are going to focus on *{environment_name} environment*, to validate the the new products version `v1.1.1` works properly.
...
*We are ready to promote the new version to production environment!!*